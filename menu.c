...
void initialiser (Objet *newgame,Objet *settings,Objet *icon,Objet *in_sound ,Objet *in_sound25,Objet *in_sound50,Objet *in_sound75,Objet *in_sound100,Objet *in_settings,Objet *main_menu ,Objet *quitter,Objet *wexit,Objet *nwexit ,Objet *exxit,Objet *game)
{
  ...
  newgame->pos.x=0 ;
  newgame->pos.y=0 ;
  newgame->pos_text.w=400 ;
  newgame->pos_text.h=150 ;
  newgame->pos_text.x=40 ;
  newgame->pos_text.y=360 ;
  ...
  settings->pos.x=0 ;
  settings->pos.y=0 ;
  settings->pos_text.w=400 ;
  settings->pos_text.h=150 ;
  settings->pos_text.x=40 ;
  settings->pos_text.y=556 ;
  ...
  quitter->pos.x=0 ;
  quitter->pos.y=0 ;
  quitter->pos_text.w=400 ;
  quitter->pos_text.h=150 ;
  quitter->pos_text.x=40 ;
  quitter->pos_text.y=744 ;
  ...
  wexit->pos_text.x=453 ;
  wexit->pos_text.y=1497 ;
  ...
  nwexit->pos_text.x=540  ;
  nwexit->pos_text.y=1497  ;
...
void liberate (Objet *newgame,Objet *settings,Objet *icon,Objet *in_sound ,Objet *in_sound25,Objet *in_sound50,Objet *in_sound75,Objet *in_sound100,Objet *in_settings,Objet *main_menu ,Objet *quitter,Objet *wexit,Objet *nwexit ,Objet *exxit,Objet *game)
{
...
void clic_souris_menu_principale (SDL_Surface *screen,SDL_Event event, int curseur ,Objet newgame,Objet settings,Objet in_settings,Objet *icon,Objet quitter,int *in,int *running,int *boolean_icon,int *quitt,Objet exxit)
{
...
void mouse_motion_main_menu (SDL_Surface *screen ,SDL_Event event,Mix_Chunk *effect,int *curseur,Objet newgame,Objet icon,Objet settings,Objet quitter,int *quitt )
{
          if(verif_motion_surface (event,newgame)) 
            {
              if((*curseur)==1)
...
void deplacementmenu_down (SDL_Surface *screen ,Mix_Chunk *effect,int *curseur,Objet newgame,Objet icon,Objet settings,Objet quitter,int *quitt )
{
               (*curseur)++ ;
               if((*curseur)<4)
                switch ((*curseur))
...
void deplacementmenu_up (SDL_Surface *screen ,Mix_Chunk *effect,int *curseur,Objet newgame,Objet icon,Objet settings,Objet quitter,int *firsttime,int *quitt)
{
...
int deplacementmenu_up_down(SDL_Surface *screen, SDL_Event event ,int *firsttime,int *curseur,int *running,Objet newgame,Objet settings ,Objet quitter ,Objet *icon,Objet in_settings , Mix_Chunk *effect,int *boolean_icon,int *quitt,Objet exxit)
{
    ...
    switch (event.type)
    {
      ...
      *running = 0;
      ...
      case SDL_MOUSEBUTTONDOWN:
           clic_souris_menu_principale (screen,event, *curseur ,newgame,settings,in_settings,icon,quitter,&in,running,boolean_icon,quitt,exxit) ;                   
      break;
      case SDL_MOUSEMOTION:
           mouse_motion_main_menu (screen , event,effect,curseur,newgame,*icon,settings,quitter,quitt ) ;
      break;
      case SDL_KEYDOWN:
          switch (event.key.keysym.sym)
          {
           ...
           break ;
           case SDLK_DOWN :
               deplacementmenu_down (screen ,effect,curseur,newgame,*icon,settings,quitter,quitt ) ;
           break ;
           case SDLK_UP :
               deplacementmenu_up (screen ,effect,curseur,newgame,*icon,settings,quitter,firsttime,quitt ) ;
           break ;
...
void deplacement__sousmenu_down (SDL_Surface *screen ,Mix_Chunk *effect,int *curseur,Objet in_sound,Objet in_sound25,Objet in_sound50,Objet in_sound75,Objet in_sound100,int position_volume,Objet icon,Objet main_menu)
{
                (*curseur)++ ;
               if((*curseur)<3)
                switch ((*curseur))
...
void deplacement__sousmenu_up (SDL_Surface *screen ,Mix_Chunk *effect,int *curseur,Objet in_sound,Objet in_sound25,Objet in_sound50,Objet in_sound75,Objet in_sound100,int position_volume,Objet icon,Objet main_menu,int *firsttime)
{
               if((*curseur)==0 && (*firsttime)==0)
               {
                 update_volume_surface(screen,effect,in_sound ,in_sound25,in_sound50,in_sound75,in_sound100,position_volume) ;
...
void motion_souris_sousmenu (SDL_Surface *screen ,SDL_Event event , Mix_Chunk *effect,int *curseur,Objet in_sound,Objet in_sound25,Objet in_sound50,Objet in_sound75,Objet in_sound100,int position_volume,Objet icon,Objet main_menu)
{
...
void clic_souris_sousmenu (SDL_Surface *screen,Objet *icon, SDL_Event event,int curseur,Objet in_sound, Objet main_menu,int *running2,Objet game,int *boolean_icon)
{
             if (event.button.button == SDL_BUTTON_LEFT && (curseur)==1 )
           {
            if(verif_motion_surface (event,in_sound)) 
   ...
   SDL_WaitEvent(&event);
    switch (event.type)
    {
      ...
      *running2=0 ;
      break ;
      case SDL_MOUSEBUTTONDOWN:
            clic_souris_sousmenu (screen,icon,event,*curseur,in_sound,main_menu,running2,game,boolean_icon)  ;                
      break;
      case SDL_MOUSEMOTION:
            motion_souris_sousmenu (screen ,event , effect,curseur,in_sound,in_sound25,in_sound50,in_sound75,in_sound100,*position_volume,*icon,main_menu) ;
      break;
      case SDL_KEYDOWN:
          switch (event.key.keysym.sym)
          {
           ...
           *running2=0 ;
           ...
           break ;
           case SDLK_DOWN :
               deplacement__sousmenu_down (screen ,effect,curseur,in_sound,in_sound25,in_sound50,in_sound75,in_sound100,*position_volume,*icon,main_menu) ;
           break ;
           case SDLK_UP :
               deplacement__sousmenu_up (screen ,effect,curseur,in_sound,in_sound25,in_sound50,in_sound75,in_sound100,*position_volume,*icon,main_menu,firsttime) ;
           break ; 
           case SDLK_RIGHT :
              (*position_volume)++ ;
