...
int deplacementmenu_up_down(SDL_Surface *screen, SDL_Event event ,int *curseur,int *running,Objet newgame,Objet loadgame,Objet settings ,Objet quitter ,Objet *icon,Objet in_settings , Mix_Chunk *effect,int *boolean_icon,int *quitt,Objet exxit)
{
      ...
      *running = 0;
      ...
      case SDL_KEYDOWN:
          switch (event.key.keysym.sym)
          {
           ...
           break ;
           case SDLK_UP :
               deplacementmenu_up (screen ,effect,curseur,newgame,*icon,loadgame,settings,quitter,quitt ) ;
           break ;
      ...
      *running2=0 ;
      ...
      case SDL_KEYDOWN:
           ...
           *running2=0 ;
           ...
           break ;
           case SDLK_UP :
               deplacement__sousmenu_up (screen ,effect,curseur,in_sound,in_sound25,in_sound50,in_sound75,in_sound100,*position_volume,*icon,credits,main_menu,j1 ,  j2 , joueur , mode,  souris , clavier ,  manette,*position_mode, *position_j) ;
           break ; 
           case SDLK_RIGHT :
           if((*curseur)==1)
             {
